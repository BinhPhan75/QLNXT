# Project Instructions for NGHIATINGOLD
...
- **Typography**: Use Serif for headings (NGHIA) and Sans-serif for secondary text (TINGOLD).
- **Consistency**: Use the constants defined in `src/constants.ts` for app-wide strings and assets.
